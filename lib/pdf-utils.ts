...
/**
 * Adds a footer with ChatLima.com branding to the current page.
 * @param doc - The jsPDF document instance.
...
export function addFooter(
    ...
    doc.text('Generated by ChatLima.com', pageWidth / 2, footerY, { align: 'center' });
...
/**
 * Adds ChatLima.com header branding to the top-right corner of the page.
 * @param doc - The jsPDF document instance.
 * @param pageWidth - The width of the page in mm.
...
export function addHeaderBranding(
    ...
    doc.text('ChatLima.com', pageWidth - margin, 20, { align: 'right' });
