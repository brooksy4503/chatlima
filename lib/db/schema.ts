...
export const tokenUsageMetrics = pgTable('token_usage_metrics', {
  ...
  estimatedCost: numeric('estimated_cost', { precision: 13, scale: 9 }).default('0').notNull(),
  actualCost: numeric('actual_cost', { precision: 13, scale: 9 }),
...
export const modelPricing = pgTable('model_pricing', {
  ...
  modelId: text('model_id').notNull(),
  provider: text('provider').notNull(),
  inputTokenPrice: numeric('input_token_price', { precision: 13, scale: 9 }).notNull(),
  outputTokenPrice: numeric('output_token_price', { precision: 13, scale: 9 }).notNull(),
  currency: text('currency').default('USD').notNull(),
...
export const dailyTokenUsage = pgTable('daily_token_usage', {
  ...
  totalTokens: integer('total_tokens').default(0).notNull(),
  totalEstimatedCost: numeric('total_estimated_cost', { precision: 13, scale: 9 }).default('0').notNull(),
  totalActualCost: numeric('total_actual_cost', { precision: 13, scale: 9 }).default('0').notNull(),
